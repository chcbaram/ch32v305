...
// static firm_ver_t *p_boot_ver = (firm_ver_t *)(FLASH_ADDR_BOOT_VER);
// static firm_ver_t *p_firm_ver = (firm_ver_t *)(FLASH_ADDR_FW_VER);
static firm_tag_t *p_firm_tag = (firm_tag_t *)(FLASH_ADDR_TAG);
